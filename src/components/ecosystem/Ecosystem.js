...
const Ecosystem = () => {
  ...
  return (
    <section className="ecosystem orange-background  ">
      <div className="container-80 mx-auto ">
        ...
        <div className=" row mx-auto justify-content-between align-items-center">
          <div className="col-md-3  col-sm-5 m-1 p-1 img-card2 shadow-card white-background   d-flex flex-column justify-content-center align-items-center ">
