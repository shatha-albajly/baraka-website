    ...
    <section className="committee py-5">
      <div className="container-80 mx-auto d-flex flex-column  justify-content-center align-items-center">
        ...
        <div className="row  mx-auto committee-cards  justify-content-between  align-items-center">
          <div className="mx-auto col-md-3 col-sm-5 p-2 img-card my-2 shadow-card d-flex flex-column justify-content-center align-items-center  ">
            <img src={Img1} className="mw-100" />
          </div>
          <div className="mx-auto col-md-3 col-sm-5 p-2 my-2 img-card shadow-card d-flex flex-column justify-content-center align-items-center  ">
